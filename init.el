...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org2jekyll ox-gfm yasnippet helm-xref org cquery lsp-python company-lsp lsp-ui lsp-mode dante idris-mode popwin switch-window helm-projectile use-package undo-tree rainbow-delimiters magit-gitflow idea-darkula-theme helm company aggressive-indent))))
(custom-set-faces
